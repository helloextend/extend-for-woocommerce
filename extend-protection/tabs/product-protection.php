...
if (is_woocommerce_activated() ) {
    ...
    if (! $post_id ) {
        HelloExtend_Protection_Logger::extend_log_error('Extend Product Protection item is missing. Please use the create item button in the Extend Settings page');
