...
$output .= '<h4 style="margin-bottom: 0px;">'.__('Errors', 'extend-protection').'</h4><pre>HelloExtend_Protection_Logger::extend_log_error( $message );</pre>';
$output .= '<h4 style="margin-bottom: 0px;">'.__('Notices', 'extend-protection').'</h4><pre>HelloExtend_Protection_Logger::extend_log_notice( $message );</pre>';
$output .= '<h4 style="margin-bottom: 0px;">'.__('Debugs', 'extend-protection').'</h4><pre>HelloExtend_Protection_Logger::extend_log_debug( $message );</pre>';
...
$output .= '<pre>HelloExtend_Protection_Logger::extend_log_error( \'' . __('There was an error with my theme', 'extend-protection') . '\' );</pre>';
...
HelloExtend_Protection_Logger::extend_log_error( $message );</pre>';
