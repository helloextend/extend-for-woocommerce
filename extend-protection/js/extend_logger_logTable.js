...
function extend_loggerDeleteAll() {
    ...
    $( '.extend_logger-delete-all' ).on( 'click', function() {
...
function extend_loggerLogFilter() {
    ...
    $( '.extend_logger-log-filter' ).on( 'click', function() {
...
function extend_loggerAbToggle() {
    ...
    $( '#extend_logger_ab_show' ).change( function() {
...
function extend_loggerHighlightNewLogs() {
    ...
    $( '.extend_logger-new-log' ).each( function() {
