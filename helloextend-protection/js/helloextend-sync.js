(function ( $ ) {
    ...
    $(document).ready(
        function ($) {
            ...
            const { store_id: storeId, ajaxurl, environment, nonce, helloextend_sync_batch } = ExtendWooCommerce;
            ...
            var currentIndex = 0;
            var batchSize = helloextend_sync_batch > 0 ? helloextend_sync_batch  : 100; // Number of products to process per AJAX call
                    ...
                    $.ajax(
                        {
                            ...
                            url:    ajaxurl,
                            data: {
                                action: 'helloextend_catalog_sync_reset'
                            },
                            success: function () {
                ...
                $.ajax(
                    {
                        ...
                        url: ajaxurl,
                        data: {
                            action:     'helloextend_catalog_sync_run',
