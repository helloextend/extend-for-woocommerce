...
function helloextend_render_settings_page()
{
    ...
    echo ' <img src="' . esc_url(plugins_url() . '/helloextend-protection/images/Extend_logo_slogan.svg') . '" alt="Extend Logo with Slogan" style="width: 170px;">
			<p>Extend Protection generates new revenue for your store, increases overall purchase conversions, and provides customers with streamlined product protection and peace of mind. <a href="https://extend.com/merchants">Learn more</a><br/>
